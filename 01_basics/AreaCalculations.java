...
public class AreaCalculations {
    public static void main(String[] args) {
        ...
        System.out.println(
                "The area of the rectangle with length " + length + " and width " + width + " is: " + (length * width));
        ...
        System.out.println("The area of the square with height " + height + " and width " + squareWidth + " is: "
                + (height * squareWidth));
