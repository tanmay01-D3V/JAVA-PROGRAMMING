...
public class shopping {
        ...
        void updateCartTable() {
            ...
            for (CartItem item : cart) {
                cartModel.addRow(new Object[] {
                        item.product.id, item.product.name, item.product.price, item.quantity, item.getTotal()
                });
            }
        }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new shopping().new ShoppingUI().setVisible(true));
    }
}
